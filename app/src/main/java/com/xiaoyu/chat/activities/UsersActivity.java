...
import com.xiaoyu.chat.adapter.UsersAdapter;
import com.xiaoyu.chat.databinding.ActivityUsersBinding;
...
public class UsersActivity extends BaseActivity implements UserListener {
    ...
    private UsersAdapter usersAdapter= new UsersAdapter(users, this);
    ...
    private void setListeners() {
        ...
        binding.searchFilter.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                Log.e("Debug User Array : ", users.toString());
            }
